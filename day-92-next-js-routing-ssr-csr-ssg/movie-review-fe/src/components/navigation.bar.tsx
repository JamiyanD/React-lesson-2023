  ...
  return (
    <div className={styles.font}>
      <div className={styles.main}>
        ...
        <div className={styles.toolsDiv}>
          <div className={styles.toolsUp}>
            <h5 className="">What's the Tomatometer®?</h5>
            <h5 className="">Critics</h5>
      ...
      <div className={styles.navDown}>
        <div className={styles.navDownDiv1}>
          <h5 style={{ color: "#ffe400" }}>TRENDING ON RT </h5>
          <p> The Super Mario Bros. Movie First Reviews </p>
        </div>
        <div className={styles.navDownDiv2}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
